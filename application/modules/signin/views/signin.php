        ...
        <?php echo form_open();?>
          ...
          <div class="profile__form">
            <div class="profile__fields">
              <div class="field">
                <input name="email" value="admin@dokkapal.com" type="email" id="fieldUser" class="input" placeholder="Email" required pattern=.*\S.* />
                <!-- <label for="fieldUser" class="label">Email</label> -->
              </div>
              <div class="field">
                <input name="password" value="admin@dokkapal.com" type="password" id="fieldPassword" class="input" placeholder="Password" required pattern=.*\S.* />
