	    	...
	    	<div class="card">
			  ...
			  <div class="card-body">
			  	<div class="alert alert-success">
				    <strong>Catatan:</strong> Data yang ditampilkan adalah data permohonan yang sudah dilakukan validasi pembayaran
				</div>
						        ...
						        <tbody>
						    		<?php if(!empty($selected_tahun)){
						    			...
						    			$sql = "SELECT a.tgl_mohon,						    			               
						    			               c.nama AS nama_agen,
						    			               CONCAT(b.nama_kapal , ' (' , b.kode_pengenal , ')') AS nama_kapal,
						    			               b.jenis_kapal,
						    			               b.imo_number,
						    			               b.grt,
						    			               b.kapasitas_roda_dua,
						    			               b.kapasitas_roda_empat,
						    			               b.kapasitas_penumpang,						    			               
						    			               d.arti_singkat AS status
						    			        FROM sertifikat_keselamatan a
						    			        LEFT JOIN kapal b ON a.kapal_id = b.id
						    			        LEFT JOIN pemohon c ON b.pemohon_id = c.id						    			       
								                LEFT JOIN kode_status d ON a.status = d.kode_angka          
						    			...
						    			foreach ($bms->result_array() as $bm) { ?>
						    				<tr>
						    					...
						    					<td><?php echo $bm['nama_agen'];?></td>
						    					<td><?php echo $bm['nama_kapal'];?></td>
						    					<td><?php echo $bm['jenis_kapal'];?></td>
						    					<td><?php echo $bm['imo_number'];?></td>						    					
						    					<td><?php echo $bm['grt'];?></td>						    					
						    					<td>
						    						Kapasitas R2 : <?php echo $bm['kapasitas_roda_dua'];?> </br>
						    						Kapasitas R4 : <?php echo $bm['kapasitas_roda_empat'];?> </br>
						    						Kapasitas penumpang : <?php echo $bm['kapasitas_penumpang'];?> </b>
						    					</td>
		...
		window.onload = function() {
			...
			window.myLine = Chart.Line(ctx, {
				...
				options: {
					...
					title: {
						display: true,
						text: 'Jumlah permohonan sertifikat keselamatan per tahun'
					},
					scales: {
						yAxes: [
							{
