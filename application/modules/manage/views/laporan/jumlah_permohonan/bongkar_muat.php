                        	...
                        	<table id="example" class="display" style="width:100%">
						        ...
						        <tbody>
						    		<?php if(!empty($selected_tahun)){
						    			...
						    			$sql = "SELECT a.tgl_mohon,IFNULL(a.tgl_pelaksanaan,'-') AS tgl_pelaksanaan,
						    			               b.nama AS perusahaan,a.jenis_muatan,
						    			               a.bobot,a.nama_kapal AS kapal,a.jenis_angkutan,
						    			               c.arti_singkat AS status
						    			        FROM bongkar_muat a
						    			        LEFT JOIN pemohon b ON a.pemohon_id = b.id
						    			        LEFT JOIN kode_status c ON a.status = c.kode_angka
						    			...
						    			foreach ($bms->result_array() as $bm) { ?>
						    				<tr>
						    					...
						    					<td><?php echo $bm['tgl_pelaksanaan'];?></td>
						    					<td><?php echo $bm['perusahaan'];?></td>
						    					<td><?php echo $bm['jenis_muatan'];?></td>
						    					<td><?php echo $bm['bobot'];?></td>
						    					<td><?php echo $bm['jenis_angkutan'];?></td>
						    					<td><?php echo $bm['kapal'];?></td>
		...
		window.onload = function() {
			...
			window.myLine = Chart.Line(ctx, {
				...
				options: {
					...
					title: {
						display: true,
						text: 'Jumlah Permohonan Bongkar Muat Barang Berbahaya'
					},
					scales: {
						yAxes: [
							{
